    ...
    return (
        <div className='section6 d-flex justify-content-center align-items-center flex-column mt190' >
            <div className=' text-center'>
                <h2 className='display-3 text-center text-black fw-bolder'>
                    ...
                    <Col lg="4" md="6" className=''>
                        <div className='m-1 mt-3  '>
                            ...
                            <div className='mt-2'>
                                ...
                                <p className='fs-4 fw-bold text-secondary'>Boost your credibility with an industry-transforming martech company
                    ...
                    <Col lg="4" md="6" className=''>
                        <div className='m-1 mt-3  '>
                            ...
                            <div className='mt-2'>
                                ...
                                <p className='fs-4 fw-bold text-secondary'>Expand your business by offering XIRCLS solutions to existing & new
                    ...
                    <Col lg="4" md="6" className=''>
                        <div className='m-1 mt-3  '>
                            ...
                            <div className='mt-2'>
                                ...
                                <p className='fs-4 fw-bold text-secondary'>Earn upto 20% commission per sale on first & recurring sales.</p>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col lg="4" md="6" className=''>
                        <div className='m-1 mt-3  '>
                            ...
                            <div className='mt-2'>
                                ...
                                <p className='fs-4 fw-bold text-secondary'>Get paid for any visitor who makes a purchase within 120 days of
                    ...
                    <Col lg="4" md="6" className=''>
                        <div className='m-1 mt-3  h-shadow '>
                            ...
                            <div className='mt-2'>
                                ...
                                <p className='fs-4 fw-bold text-secondary'>Earn sales commissions in the currencies that your clients purchase
                    ...
                    <Col lg="4" md="6" className=''>
                        <div className='m-1 mt-3  '>
                            ...
                            <div className='mt-2'>
                                ...
                                <p className='fs-4 fw-bold text-secondary'>Our team is accustomed to working with partners across the globe.
