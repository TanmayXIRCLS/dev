            ...
            <Row className='text-center match-height w-75'>
                <Col lg="4" md="6" className=' d-flex justify-content-center align-items-center'>
                    <div >
                        ...
                        <h4 className='display-5 fw-bolder text-black' >Who can become a XIRCLS partner ?</h4>
                    </div>
                </Col>
                <Col lg="4" md="6" className=''>
                    <div className='mt-1 p-2'>
                        ...
                        <div className='mt-2'>
                            ...
                            <p className='fs-4 fw-bold text-secondary'>who can offer XIRCLS integrations as value additions in their tech stack.</p>
                        </div>
                    </div>
                </Col>
                <Col lg="4" md="6" className=''>
                    <div className='mt-1 p-2'>
                        ...
                        <div className='mt-2'>
                            ...
                            <p className='fs-4 fw-bold text-secondary'>who want to recommend XIRCLS solutions to their clients.</p>
                        </div>
                    </div>
                </Col>
                ...
                <Col lg="4" md="6" className=''>
                    <div className='mt-1 p-2'>
                        ...
                        <div className='mt-2'>
                            ...
                            <p className='fs-4 fw-bold text-secondary'>Such as incubators & accelerators who wish to offer startups a sustainable way to kickstart revenue generations.</p>
                        </div>
                    </div>
                </Col>
                <Col lg="4" md="6" className=''>
                    <div className='mt-1 p-2'>
                        ...
                        <div className='mt-2'>
                            ...
                            <p className='fs-4 fw-bold text-secondary'>Interested in earning commission by referring their audience.</p>
                        </div>
                    </div>
                </Col>
                <Col lg="4" md="6" className=''>
                    <div className='mt-1 p-2'>
                        ...
                        <div className='mt-2'>
                            ...
                            <p className='fs-4 fw-bold text-secondary'>Such as resellers, consultancies who offer consulting & implementation services</p>
                        </div>
                    </div>
                </Col>
            </Row>
