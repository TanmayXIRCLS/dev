    ...
    return (
        <div className='section11 d-flex justify-content-center  align-items-center flex-column mt80 ' >
            ...
            <section id="faq" class="faq " style={{ width: "70%"}}>
                <div >
                    <h2 className='text-center display-6  fw-bolder my-4 text-black'      > <span className='text-orange'>F</span>requently <span className='text-orange'>A</span>sked <span className='text-orange'>Q</span>uestions</h2>
                </div>
