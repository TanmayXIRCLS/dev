                                ...
                                <div className='section-2-card-bottom' style={{ marginTop: "5vh" }}>
                                    <div className='section-2-card-1 d-flex'>
                                        <div className='section-2-card-img'>
                                            <img className='user' src={require("./Assets/user.png")} style={{ width: "5vh" }} alt="img"></img>
                        ...
                        <CardBody>
                            <div className='section-2-card'>
                                ...
                                <div className='section-2-card-bottom-1' style={{ marginTop: "8vh" }}>
                                    <div className='section-2-card-1 d-flex'>
                                        <div className='section-2-card-img'>
                                            <img className='rupee' src={require("./Assets/rupee.png")} style={{ width: "4vh", height: "5vh" }} alt="img"></img>
                                        </div>
                                        <div className='section-2-card-info' style={{ marginLeft: "3vh" }}>
                        ...
                        <CardBody>
                            <div className='card-contend text-center'>
                                <div className='card-img'>
                                    <img className='giftbox' src={require("./Assets/giftbox.png")} style={{ width: "5vh" }} alt="img"></img>
                                </div>
                ...
                <Col sm={12} md={6} xl={4}>
                    <Card>
                        <CardBody>
                            <div className='card-contend text-center'>
                                <div className='card-img'>
                                    <img className='sponser' src={require("./Assets/sponser.png")} style={{ width: "5vh" }} alt="img"></img>
                                </div>
                                <div className='card-heading mt-1'>
                                    <h5>0</h5>
                                </div>
                        ...
                        <CardBody>
                            <div className='section-4-card-2 d-flex justify-content-between'>
                                ...
                                <div className='section-4-cad-1-img'>
                                    <img className='voucher' src={box} style={{ width: "5vh" }} alt="img"></img>
                                </div>
                            </div>
                        </CardBody>
                    </Card>
                        ...
                        <CardBody>
                            <div className='section-4-card-2 d-flex justify-content-between'>
                                ...
                                <div className='section-4-card-1-img'>
                                    <img className='income' src={require("./Assets/income.png")} style={{ width: "5vh" }} alt="img"></img>
                                </div>
                            </div>
                        </CardBody>
                    </Card>
