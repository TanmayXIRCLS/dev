...
export const Section6 = () => {
    return (
        <Row className=" justify-content-center " style={{ marginTop: "170px", background: "#000" }}>
            <Col lg="10" xs="10">
                <Row>
                    <Col md={6} className="mt-5 mb-5" style={{ paddingTop: "5vh", paddingBottom: "7vh" }}>
                        <div className=" ms-5 mt-4 mb-4">
                            ...
                            <div className='section6-buttons mt-5'>
                                <Button className='btn-lg fs-3 px-3 py-1' variant="primary">Submit an App</Button>
                                <Button className=' ms-sm-4 btn-lg fs-3 px-3 py-1' variant="outline-light">Explore Marketplace</Button>
                            </div>
