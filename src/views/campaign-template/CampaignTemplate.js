                ...
                campaignOptions.map((option) => (
                  <Col key={option.id} className='p-0 mx-1' >
                    <div
                      ...
                      className={` py-1  border border-primary rounded d-flex flex-column justify-content-center align-items-center ${selectedOptions.includes(option.id) ? 'bg-primary  bg-opacity-25' : ''
                        }`}
